...
export function StepContact() {
  ...
  return (
    <fieldset className="space-y-6">
      ...
      <div>
        <span className="mb-1.5 block text-sm font-medium text-ink">Timing</span>
          ...
          {urgencyOptions.map((option) => (
            <label
              ...
              className={cn(
                ...
                urgency === option.value ? "border-copper bg-copper-light/20" : "border-border hover:border-ink/30"
              )}
            >
              ...
              <span
                className={cn(
                  ...
                  urgency === option.value ? "border-copper bg-copper" : "border-ink/30"
                )}
                aria-hidden="true"
              />
      ...
      <div>
        <span className="mb-1.5 block text-sm font-medium text-ink">Preferred contact method</span>
            ...
            <label
              ...
              className={cn(
                ...
                contactMethod === option.value
                  ? "border-copper bg-copper-light/20 text-ink"
